...
import com.Soham.Account_Service.Services.PaymentProcessor;
...
import static com.Soham.Common_Lib.Enums.SubcriptionStatus.TRAILING;
...
public class StripePaymentProcessor implements PaymentProcessor {
    ...
    public CheckoutResponse createCheckoutSeesionUrl(CheckoutRequest request) {
        ...
        com.Soham.Account_Service.Entities.Plan plan = planRepository.findById(request.planId())
                .orElseThrow(() ->
    ...
    private Long resolvePlanId(Price price) {
        ...
        return planRepository.findByStripePriceId(price.getId())
                .map(com.Soham.Account_Service.Entities.Plan::getId)
                .orElse(null);
    }
